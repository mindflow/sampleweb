...
MappedListIterable: {"": "ListIterable;_liblib2$_source,_f",
  ...
  get$length: function(_) {
    return $.get$length$asx(this._liblib2$_source);
  },
  elementAt$1: function(_, index) {
    return this._f$1($.elementAt$1$ax(this._liblib2$_source, index));
  },
  $asIterable: function (S, T) { return [T]; }
},
...
_BufferingStreamSubscription: {"": "Object;_liblib1$_onData,_onError,_onDone,_state@,_pending",
...
_ForwardingStreamSubscription: {"": "_BufferingStreamSubscription;_stream,_subscription,_liblib1$_onData,_onError,_onDone,_state,_pending",
  _liblib1$_add$1: function(data) {
    if ((this._state & 2) !== 0)
      return;
...
ReceivePort: {"": "Object;"}}],
["hi", "sample.dart", , {
makeRequest_closure: {"": "Closure;request_0",
  call$1: function(e) {
    return $.requestComplete(this.request_0);
  }
},
...
main: function() {
  ...
  t1 = document.querySelector("#makeRequest");
  t1.get$onClick;
  t1 = new $._EventStream(t1, $.EventStreamProvider_click._eventType, false);
  t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, $.makeRequest$closure, t1._useCapture);
  t2 = t1._onData;
...
makeRequest: function(e) {
  ...
  $.HttpRequest_methods.open$2(request, "GET", "/HelloContent?input=SomeOtherInput");
  t1 = new $._EventStream(request, $.EventStreamProvider_loadend._eventType, false);
  t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.makeRequest_closure(request), t1._useCapture);
  t2 = t1._onData;
  if (t2 != null && !t1.get$isPaused())
    $.$$dom_addEventListener$3$x(t1._target, t1._eventType, t2, t1._useCapture);
  request.send();
...
requestComplete: function(request) {
  ...
  if (request.status === 200) {
    ...
    $.set$innerHtml$x(document.querySelector("#id5"), text);
  } else
    document.querySelector("#id5").textContent = "Error";
}}],
...
["metadata", "/C:/Users/tn/Desktop/eclipse/dart-sdk/lib/html/html_common/metadata.dart", , {
